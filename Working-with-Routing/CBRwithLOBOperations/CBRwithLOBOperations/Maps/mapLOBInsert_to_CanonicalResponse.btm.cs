namespace CBRwithLOBOperations.Maps {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"CBRwithLOBOperations.SQL_OP_TableOperation_dbo_Person+InsertResponse", typeof(global::CBRwithLOBOperations.SQL_OP_TableOperation_dbo_Person.InsertResponse))]
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"CBRwithLOBOperations.Response", typeof(global::CBRwithLOBOperations.Response))]
    public sealed class mapLOBInsert_to_CanonicalResponse : global::Microsoft.XLANGs.BaseTypes.TransformBase {
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 s1 s2 userCSharp"" version=""1.0"" xmlns:ns0=""http://CBRwithLOBOperations.Response"" xmlns:s0=""http://schemas.microsoft.com/2003/10/Serialization/Arrays"" xmlns:s1=""http://schemas.microsoft.com/Sql/2008/05/Types/Tables/dbo"" xmlns:s2=""http://schemas.microsoft.com/Sql/2008/05/TableOp/dbo/Person"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/"">
    <xsl:apply-templates select=""/s2:InsertResponse"" />
  </xsl:template>
  <xsl:template match=""/s2:InsertResponse"">
...
public string SetConstantValue(string value)
{
	return value;
        ...
        private const string _strSrcSchemasList0 = @"CBRwithLOBOperations.SQL_OP_TableOperation_dbo_Person+InsertResponse";
        
        private const global::CBRwithLOBOperations.SQL_OP_TableOperation_dbo_Person.InsertResponse _srcSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"CBRwithLOBOperations.SQL_OP_TableOperation_dbo_Person+InsertResponse";
                return _SrcSchemas;
            }
        }
