namespace WorkingWithConditions {
    ...
    [Schema(@"http://WorkingWithConditions.Conditions",@"Conditions")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"Conditions"})]
    public sealed class Conditions : Microsoft.XLANGs.BaseTypes.SchemaBase {
