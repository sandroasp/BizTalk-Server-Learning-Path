namespace ComoFuncinamOsMapas.Schemas {
    ...
    [Schema(@"http://ComoFuncinamOsMapas.PessoaDestino",@"PessoaDestino")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"PessoaDestino"})]
    public sealed class PessoaDestino : Microsoft.XLANGs.BaseTypes.SchemaBase {
