namespace LoopingPattern._01_LoppingTypes._06_NestedToNested.OtherExample {
    ...
    public sealed class NestedFamiliesMap : global::Microsoft.XLANGs.BaseTypes.TransformBase {
  ...
  <xsl:template match=""/s0:Families"">
    <ns0:ApplicationForm>
      <xsl:for-each select=""Family"">
        ...
        <xsl:variable name=""var:v2"" select=""count(/s0:Families/Family/Parents/Child)"" />
        <Form>
          <LineId>
          ...
          <Parents>
            <xsl:for-each select=""Parents/Name"">
              <xsl:variable name=""var:v3"" select=""userCSharp:LogicalEq(string(@Sex) , &quot;M&quot;)"" />
              ...
              <Parent>
                ...
                <xsl:if test=""string($var:v3)='true'"">
                  <xsl:variable name=""var:v4"" select=""&quot;Father&quot;"" />
                  <Type>
                    <xsl:value-of select=""$var:v4"" />
                  </Type>
                </xsl:if>
                <xsl:if test=""string($var:v5)='true'"">
                  <xsl:variable name=""var:v6"" select=""&quot;Mother&quot;"" />
                  <Type>
