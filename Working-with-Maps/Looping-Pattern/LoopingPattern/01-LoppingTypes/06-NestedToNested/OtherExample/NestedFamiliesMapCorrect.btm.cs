namespace LoopingPattern._01_LoppingTypes._06_NestedToNested.OtherExample {
    ...
    public sealed class NestedFamiliesMapCorrect : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        ...
        <Form>
          ...
          <xsl:for-each select=""Parents"">
            ...
            <xsl:for-each select=""Child"">
              ...
              <xsl:if test=""string($var:v3)='true'"">
                ...
                <xsl:variable name=""var:v5"" select=""userCSharp:AddToCumulativeSum(0,string($var:v4),&quot;1&quot;)"" />
              </xsl:if>
            </xsl:for-each>
          ...
          <Parents>
            <xsl:for-each select=""Parents/Name"">
              <xsl:variable name=""var:v7"" select=""userCSharp:LogicalEq(string(@Sex) , &quot;M&quot;)"" />
              ...
              <Parent>
                ...
                <xsl:if test=""string($var:v7)='true'"">
                  <xsl:variable name=""var:v8"" select=""&quot;Father&quot;"" />
                  <Type>
                    <xsl:value-of select=""$var:v8"" />
                  </Type>
                </xsl:if>
                <xsl:if test=""string($var:v9)='true'"">
                  <xsl:variable name=""var:v10"" select=""&quot;Mother&quot;"" />
                  <Type>
