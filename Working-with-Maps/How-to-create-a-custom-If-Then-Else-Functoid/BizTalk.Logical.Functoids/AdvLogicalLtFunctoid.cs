...
{
    [Serializable]
    public class AdvLogicalLtFunctoid : BaseFunctoid
    {
        public AdvLogicalLtFunctoid()
        {
            ...
            SetName("IDS_ADVLOGICALLT_NAME");
            SetTooltip("IDS_ADVLOGICALLT_TOOLTIP");
            SetDescription("IDS_ADVLOGICALLT_DESCRIPTION");
            SetBitmap("IDB_ADVLOGICALLT");
        ...
        private string GetCSharpBuffer()
        {
            ...
            builder.Append("public bool LogicalLt(string val1, string val2)\n");
            builder.Append("{\n");
