...
{
    [Serializable]
    public class AdvLogicalNeFunctoid : BaseFunctoid
    {
        public AdvLogicalNeFunctoid()
            : base()
        {
            ...
            SetName("IDS_ADVLOGICALNE_NAME");
            SetTooltip("IDS_ADVLOGICALNE_TOOLTIP");
            SetDescription("IDS_ADVLOGICALNET_DESCRIPTION");
            SetBitmap("IDB_ADVLOGICALNE");
        ...
        private string GetCSharpBuffer()
        {
            ...
            builder.Append("public bool AdvLogicalNe(string val1, string val2)\n");
            builder.Append("{\n");
