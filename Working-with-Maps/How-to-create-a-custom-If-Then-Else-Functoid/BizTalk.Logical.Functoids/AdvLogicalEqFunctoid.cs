...
{
    [Serializable]
    public class AdvLogicalEqFunctoid : BaseFunctoid
    {
        public AdvLogicalEqFunctoid()
        {
            ...
            SetName("IDS_ADVLOGICALEQ_NAME");
            SetTooltip("IDS_ADVLOGICALEQ_TOOLTIP");
            SetDescription("IDS_ADVLOGICALEQ_DESCRIPTION");
            SetBitmap("IDB_ADVLOGICALEQ");
        ...
        private string GetCSharpBuffer()
        {
            ...
            builder.Append("public bool LogicalEq(string val1, string val2)\n");
            builder.Append("{\n");
