...
{
    [Serializable]
    public class AdvLogicalGteFunctoid : BaseFunctoid
    {
        public AdvLogicalGteFunctoid()
        {
            ...
            SetName("IDS_ADVLOGICALGTE_NAME");
            SetTooltip("IDS_ADVLOGICALGTE_TOOLTIP");
            SetDescription("IDS_ADVLOGICALGTE_DESCRIPTION");
            SetBitmap("IDB_ADVLOGICALGTE");
        ...
        private string GetCSharpBuffer()
        {
            ...
            builder.Append("public bool LogicalGte(string val1, string val2)\n");
            builder.Append("{\n");
