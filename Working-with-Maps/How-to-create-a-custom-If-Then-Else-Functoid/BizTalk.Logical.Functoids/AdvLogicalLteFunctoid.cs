...
{
    [Serializable]
    public class AdvLogicalLteFunctoid : BaseFunctoid
    {
        public AdvLogicalLteFunctoid()
        {
            ...
            SetName("IDS_ADVLOGICALLTE_NAME");
            SetTooltip("IDS_ADVLOGICALLTE_TOOLTIP");
            SetDescription("IDS_ADVLOGICALLTE_DESCRIPTION");
            SetBitmap("IDB_ADVLOGICALLTE");
        ...
        private string GetCSharpBuffer()
        {
            ...
            builder.Append("public bool LogicalLte(string val1, string val2)\n");
            builder.Append("{\n");
