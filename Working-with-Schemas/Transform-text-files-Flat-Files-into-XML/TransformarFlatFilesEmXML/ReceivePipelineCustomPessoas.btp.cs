namespace TransformarFlatFilesEmXML
{
    ...
    public sealed class ReceivePipelineCustomPessoas : Microsoft.BizTalk.PipelineOM.ReceivePipeline
    {
...
"       <Value xsi:type=\"xsd:string\">TransformarFlatFilesEmXML.TXT_to_XML</Value>            </Proper"+
...
"e-4cce-4536-83fa-4a5040674ad6\" />      <Components />    </Stage>  </Stages></Document>";
        ...
        private const string _versionDependentGuid = "792e74c1-133b-48ee-b3c5-1c34f311f903";
        
        public ReceivePipelineCustomPessoas()
        {
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">TransformarFlatFilesEmXM"+
"L.TXT_to_XML</Value>    </Property>    <Property Name=\"TrailerSpecName\" />    <Property Name=\"Preser"+
