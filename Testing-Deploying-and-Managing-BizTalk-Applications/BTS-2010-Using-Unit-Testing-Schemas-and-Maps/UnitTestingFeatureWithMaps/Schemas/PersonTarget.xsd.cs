namespace UnitTestingFeatureWithMaps.Schemas {
    ...
    [Schema(@"http://HowMapsWorks.PersonTarget",@"PersonTarget")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"PersonTarget"})]
    public sealed class PersonTarget : Microsoft.BizTalk.TestTools.Schema.TestableSchemaBase {
